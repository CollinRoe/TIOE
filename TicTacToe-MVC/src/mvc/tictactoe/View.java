...
public class View extends javax.swing.JFrame implements MessageHandler {
  ...
  for (int i=0; i<3; i++) {
      // BUG - Make sure we wont return if all the rows have nothing ("")
    if (status[i][0].equals("")==false && status[i][0].equals(status[i][1]) && status[i][0].equals(status[i][2])){
      return status[i][0];
    }
    // BUG - Make sure we wont return if all the columns have nothing ("")
    if (status[0][i].equals("")==false  && status[0][i].equals(status[1][i]) && status[0][i].equals(status[2][i])){
      return status[0][i];
    }
  }
  ...
  // cHECK IF ALL SPACES ARE FILLED AND THERE IS NOT WINNER THEN THIS IS A TIE
  if (this.isTie()){
      return "This is a tie. No one ";
  }
...
this.mvcMessaging.subscribe("gameOver", this);
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButton7.setActionCommand("JButton20");
        ...
        jButton8.setActionCommand("JButton21");
        ...
        jButton9.setActionCommand("JButton22");
